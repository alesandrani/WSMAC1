...
public class GestorUsuario {
	...
	/**
	 * Metodo que registra una Persona en la BBDD Verifica si el nombre de la
	 * Persona ya se encuentra en la BBDD, si no lo esta lo guarda. La contraseña se
	 * almacena de manera hasheada en la BBDD
	 * 
	 * @param p La persona que se desea registrar, que contiene el nombre y la
	 *          contraseña
	 */
